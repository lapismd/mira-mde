...
| MIRA-GOV-009, MIRA-GOV-010, MIRA-GOV-011                                                                | Changeset intent gate, npm integrity response normalization, protected release workflow, post-publish checks, and package GitHub release-note tests | Implemented                                                                                        |
...
| MIRA-ARCH-039                                                                                           | Root `check`/`check:all` scripts, workspace overrides, and `pnpm audit`                                                                             | Implemented                                                                                        |
