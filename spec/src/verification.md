...
| MIRA-ARCH-016                                                                                           | Shared public graph, registry planner, tarball manifest, and release tests | Package model implemented; automation pending |
...
| MIRA-GOV-009, MIRA-GOV-010, MIRA-GOV-011                                                                | Changeset intent gate, protected release workflow, and post-publish checks | Implementation in progress                    |
