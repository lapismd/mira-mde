...
| MIRA-MD-023                                                                                             | Consumer-defined frontmatter icon assertion in Lapis Storybook              | Implemented by frontmatter icon alignment       |
...
| MIRA-UI-017                                                                                             | Frontmatter container CSS plus narrow Lapis File Properties story assertion | Implemented by responsive frontmatter alignment |
...
| MIRA-CSS-028                                                                                            | Shipped frontmatter CSS and narrow Lapis File Properties story assertion    | Implemented by responsive frontmatter alignment |
