...
| MIRA-GOV-009, MIRA-GOV-010, MIRA-GOV-011                                                                | Changeset intent gate, protected release workflow, post-publish checks, and package GitHub release-note tests                         | Implemented; external environment setup pending                                                    |
