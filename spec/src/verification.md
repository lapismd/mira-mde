...
| MIRA-CSS-016                                                                                            | Shipped source-table selector plus focused computed-style and per-line hidden-chrome overflow acceptance               | Implemented by table parity slice                                                                  |
