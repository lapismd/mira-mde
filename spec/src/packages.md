...
| MIRA-ARCH-031 | The shipped `@lapismd/mira` CodeMirror stack MUST include the semantic Find and Replace structure and plain CSS needed for inline search options, pill-shaped fields, borderless actions, and transparent, divider-free panel presentation without consumer styling.                                                                                                                                                                                             |
