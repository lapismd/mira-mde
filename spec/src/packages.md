...
| MIRA-ARCH-037 | The shipped `@lapismd/mira/preview` frontmatter component and stylesheet MUST expose the complete property type-and-action menu above its otherwise clipped property row without requiring a consumer override or alternate menu implementation.                                                                                                                                                                                                                                   |
