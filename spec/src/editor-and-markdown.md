...
| MIRA-MD-007 | The comprehensive and focused Storybook fixtures MUST cover every feature listed by MIRA-MD-002. Focused indentation stories MUST keep wrapped list markers, continuation paragraphs, nested lists and blockquotes, active raw-prefix editing, and configurable indent width visible across each applicable source, live-preview, and reading surface. Ordinary list continuations MUST align with their parent item content in the default inactive render and MUST retain that content column while the caret reveals or hides their authored prefix; preformatted list content MUST retain its additional code-block offset. Enabled indentation guides MUST span the complete rendered height of every wrapped indented line. |
