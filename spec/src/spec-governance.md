...
| MIRA-GOV-013 | Repository agent guidance MUST resolve colocated LapisMD siblings through explicit `link:` dependencies or `link:`-valued root overrides, keep sibling repositories outside this pnpm workspace, preserve portable published manifests, and require built-export providers to be rebuilt before consumer validation. |
