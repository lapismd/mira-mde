...
| MIRA-CAT-015 | The focused `MiraCodeEditor` catalog MUST open the real Find interface and verify that the three query options are rendered inside the Find field while search navigation, accessible option state, and the editor-owned transparent panel surface remain available.                                                                                                                                                |
