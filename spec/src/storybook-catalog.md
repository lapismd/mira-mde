...
| MIRA-CAT-015 | The focused `MiraCodeEditor` catalog MUST open the real Find interface and verify that the three query options are rendered inside the Find field while search navigation and accessible option state remain available.                                                                                                                                                                                             |
