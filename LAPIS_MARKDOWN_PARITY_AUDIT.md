...
5. **P1 continuity:** split scrolling is correctly synchronized by ratio, but
   switching between preview and editor modes does not map the visible
   document position as Lapis does.
6. **P1 document editing:** frontmatter lacks remove/cut/copy/paste property
...
| P1       |    10 | Core authoring, continuity, and document adapters         |
