...
The most important remaining confirmed gaps are concentrated in accessibility
and document adapters:
...
2. **P1 document editing:** frontmatter lacks remove/cut/copy/paste property
...
3. **P2 reusable surfaces:** narrow embed and note-link components remain
   internal or absent, while broken-image and rendered code-label polish still
   differs from Lapis.
...
| P1       |     3 | Document editing and invalidation adapters  |
| P2       |     5 | Parity polish and reusable surfaces         |
...
Slices 1-3 added `visual-pending` stories and the tracked layout fixture. No
snapshot was created, updated, or approved.
