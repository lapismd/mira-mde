...
The remaining confirmed gaps are concentrated in accessibility and reusable
...
2. **P2 reusable surfaces:** narrow embed and note-link components remain
   internal or absent, and list-callout catalogs remain fixed rather than
   injectable.
...
| P1       |     0 | Core authoring and document adapter gaps    |
| P2       |     2 | Configurable catalog and reusable surfaces  |
...
Slices 1-4 added `visual-pending` stories and the tracked layout fixture. No
snapshot was created, updated, or approved.
