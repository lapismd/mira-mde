<script lang="ts">
  ...
  import * as Table from "@lapismd/mira/ui/table";
  ...
  import * as ContextMenu from "@lapismd/mira/ui/context-menu";
  ...
  import { DropdownMenuItem } from "@lapismd/mira/ui/dropdown-menu";
  ...
  import { tableReorderSensors } from "@lapismd/mira/ui/table-dnd/sensors";
  import {
    parseTableDragData,
